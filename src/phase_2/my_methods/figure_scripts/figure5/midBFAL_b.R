...
# for mac
setwd("/Users/dallasjordan/Desktop/StonyBrook/SoMAS/Thesis/R/spatial_segregation/pre_defense/contours_rasters_figureData/individual/midBFAL/master_script_contours/")
...
mb95c$id <- "foraging_range"
mb95c$cntr_level <- "95"

mb50c$id <- "focal_range"
mb50c$cntr_level <- "50"
...
# figure <- ggplot() + 
#   # LAAL contours
#   geom_sf(data=mb95c, aes(fill=cntr_level)) +
#   geom_sf(data=mb50c, aes(fill=cntr_level)) +
