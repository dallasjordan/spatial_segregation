...
# for mac
setwd("/Users/dallasjordan/Desktop/StonyBrook/SoMAS/Thesis/R/spatial_segregation/pre_defense/contours_rasters_figureData/individual/ternBFAL/master_script_contours/")
load("vert95_ternBFAL.Rdata")
load("vert50_ternBFAL.Rdata")

# Save one example of old method for reference: 
...
figure <- ggplot() + 
  geom_sf(data=tb95c, color="black", fill="royalblue4", size=1.25) +
  geom_sf(data=tb50c, color="black", fill="royalblue4", size=1.25) +
