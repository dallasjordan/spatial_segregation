...
# just right first
setwd("/Users/dallasjordan/Desktop/StonyBrook/SoMAS/Thesis/R/spatial_segregation/data/oceanographic_data/wind/right_all/")
...
a <- list.files("/Users/dallasjordan/Desktop/StonyBrook/SoMAS/Thesis/R/spatial_segregation/data/oceanographic_data/wind/right_all/")
...
plot(mi[1,,,3], axes=T)
# ggplot() +  
#   geom_stars(data = mi[1], alpha = 0.8, downsample = c(10, 10, 1)) + 
#   scale_fill_viridis() +
#   coord_equal() +
#   theme_map() +
...
save(all_times, file="all_times.Rdata")
save(wind_U2M,file="wind_U2M_right.Rdata")
save(wind_U10M,file="wind_U10M_right.Rdata")
save(wind_U50M,file="wind_U50M_right.Rdata")
save(wind_V2M,file="wind_V2M_right.Rdata")
save(wind_V10M,file="wind_V10M_right.Rdata")
save(wind_V50M,file="wind_V50M_right.Rdata")

# have to repeat with second data file for the left side of antimeridian
setwd("/Users/dallasjordan/Desktop/StonyBrook/SoMAS/Thesis/R/spatial_segregation/data/oceanographic_data/wind/left_all/")
#a <- list.files("/Volumes/GoogleDrive/My Drive/THORNE_LAB/Data/Feldman_Analysis/Wind/Merra-2Datasets/Hourly/Dec2019-Feb2020_WAALinc/L/", pattern = ".nc")
b <- list.files("/Users/dallasjordan/Desktop/StonyBrook/SoMAS/Thesis/R/spatial_segregation/data/oceanographic_data/wind/left_all/")
...
save(wind_U2M2,file="wind_U2M_left.Rdata")
save(wind_U10M2,file="wind_U10M_left.Rdata")
save(wind_U50M2,file="wind_U50M_left.Rdata")
save(wind_V2M2,file="wind_V2M_left.Rdata")
save(wind_V10M2,file="wind_V10M_left.Rdata")
save(wind_V50M2,file="wind_V50M_left.Rdata")
