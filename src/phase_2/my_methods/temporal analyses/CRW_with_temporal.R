# To do - fit distribution FIRST - pull out distance and turning angles
# Re run CRW on aggregate and in temporal chunks
...
# Check distributions of combined and of seasonal angles/distances --------
...
# SUMMARY OF DISTRIBUTION RESULTS 4/15 ------------------------------------
...
# CRW drawn from distributions --------------------------------------------
  # Going to conduct CRW with distributions that I determined. When I draw from 
    ...
    # Seasonal and aggregated LAAL/BFAL all are ~11.6 and ~.9. Maybe just pick the aggregated SPP values?
...
write.csv(sim_CRW_pts,file="one_iteration_of_CRW_pts_v2.csv")
write.csv(rand_out_table_birds,file="CRW_overlap_results_v2_1.csv")
write.csv(big_storage,file="all_CRW_pts_v2_1.csv")
