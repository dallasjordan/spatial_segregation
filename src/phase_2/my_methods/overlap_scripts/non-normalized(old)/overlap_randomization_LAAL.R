# Randomization procedure for comparing midLAAL and ternLAAL data
# Dallas Jordan
...
LAALmid$id <- "LAALmid"
LAALtern$id <- "LAALtern"
both <- rbind(LAALmid,LAALtern)
...
BA_95 <- original_BA_95 # 	0.8432712
BA_50 <- original_BA_50 #   0.8432712
test_stat_95 <- 0.8384691 # manually putting this in because its easier then calling from matrix
test_stat_50 <- 0.09864342 # manually putting this in because its easier then calling from matrix
