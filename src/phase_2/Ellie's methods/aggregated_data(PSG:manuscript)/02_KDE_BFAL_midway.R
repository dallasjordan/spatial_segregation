...
setwd(paste0("/Users/dallasjordan/Desktop/StonyBrook/SoMAS/Thesis/R/spatial_segregation/midway_postbreeding_exports/",SPECIES,"/",YEAR,"/"))
...
files <- list.files(paste0("/Users/dallasjordan/Desktop/StonyBrook/SoMAS/Thesis/R/spatial_segregation/midway_postbreeding_exports/",SPECIES,"/",YEAR), pattern = "csv")
...
contLevels <- c("5%","10%", "25%","50%") # these are the contour levels that will be generated in the kernel density estimation
...
# normall loop here, but since I'm just doing all LAAL, no loop:
...
ID <- paste0("KDE_midway_",SPECIES,"_",YEAR)  # or something
